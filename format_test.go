...
var formatTestCases = []struct {
	...
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 0, 2, 3, 0, time.UTC),
		expected: "00:02:03  0 12 12 AM am",
	},
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 1, 2, 3, 0, time.UTC),
		expected: "01:02:03  1 01  1 AM am",
	},
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 11, 2, 3, 0, time.UTC),
		expected: "11:02:03 11 11 11 AM am",
	},
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 12, 2, 3, 0, time.UTC),
		expected: "12:02:03 12 12 12 PM pm",
	},
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "13:02:03 13 01  1 PM pm",
	},
	{
		format:   "%H:%M:%S %k %I %l %p %P",
		t:        time.Date(2020, time.January, 1, 23, 2, 3, 0, time.UTC),
		expected: "23:02:03 23 11 11 PM pm",
	},
	{
		format:   "%-H:%-M:%-S %-k %-I %-l %-p %-P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "13:2:3 13 1 1 PM pm",
	},
	{
		format:   "%4H:%4M:%4S %4k %4I %4l %4p %4P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "0013:0002:0003   13 0001    1   PM   pm",
	},
	{
		format:   "%_H:%_M:%_S %_k %_I %_l %_p %_P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "13: 2: 3 13  1  1 PM pm",
	},
	{
		format:   "%_4H:%_4M:%_4S %_4k %_4I %_4l %_4p %_4P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "  13:   2:   3   13    1    1   PM   pm",
	},
	{
	...
	{
		format:   "%04H:%04M:%04S %04k %04I %04l %04p %04P",
		t:        time.Date(2020, time.January, 1, 13, 2, 3, 0, time.UTC),
		expected: "0013:0002:0003 0013 0001 0001 00PM 00pm",
	},
	{
	...
	{
		format:   "%Z %^Z %#Z %#^Z %^#Z",
		t:        time.Date(2020, time.July, 24, 23, 14, 15, 0, time.FixedZone("XY", 9*60*60)),
		expected: "XY XY xy xy xy",
	},
	{
		format:   "%Z %^Z %#Z %#^Z %^#Z",
		t:        time.Date(2020, time.July, 24, 23, 14, 15, 0, time.FixedZone("X", 9*60*60)),
		expected: "X X x x x",
	},
	{
